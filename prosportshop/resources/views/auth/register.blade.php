<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="apell" class="block w-full mt-1" type="text" name="apell" :value="old('apell')"
        ...
        <div>
            ...
            <x-text-input id="direccion" class="block w-full mt-1" type="text" name="direccion" :value="old('direccion')"
